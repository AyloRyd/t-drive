        ...
        {view === "list" ? (
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
            {[...Array<number>(10)].map((_, i) => (
              <div
                key={i}
                className="relative flex min-h-[140px] flex-col items-center justify-center gap-4 rounded-xl border border-gray-700/50 bg-gray-800/30 p-6"
              >
                <div className="absolute top-3 left-3 h-4 w-4 animate-pulse rounded-[4px] bg-gray-700" />
